        ...
        <section className="w-full h-[704px] bg-img_bg_hero bg-no-repeat bg-center bg-cover">
            <Container>
                <div className="flex-1 max-w-[590px]">
                    ...
                    <p className="text-white text-xl max-w-[430px] mb-8">Todas as operações que você precisa em um só lugar. Simples, 
                    completo e feito pra você.</p>
                ...
                <Image src={WomanImage} alt="Womon" className="mr-[-41px]"/>
            </Container>
